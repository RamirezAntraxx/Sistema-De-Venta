...
cards.forEach((card, index) => {
  ...
  // Obtener el botón "Ver productos" de la ventana modal
var verProductosButton = document.getElementById('ver-productos');

// Agregar evento de clic al botón "Ver productos"
verProductosButton.addEventListener('click', function() {
  ...
  var desarrolladoresLink = document.getElementById('desarrolladores-link');
  
  // Obtener la alerta
  var accessAlert = document.getElementById('accessAlert');

  // Mostrar alerta al hacer clic en el botón "Ver productos"
